...
vgsales %>%
  ...
  scale_color_manual(values = c("red", "green","blue","black", "yellow", "deeppink", 
                                "cyan","darkmagenta","steelblue","midnightblue","sienna", "green4"))+
...
vgsales %>% 
  ...
  summarise(tvs = sum(Global_Sales)) %>% 
