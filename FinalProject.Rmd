...
regiongenresales <- vgsales %>%
  ...
  select(Genre,Year,cum_other_genre_sum,cum_JP_genre_sum,cum_EU_genre_sum,cum_NA_genre_sum)
  


g1 <- ggplot(regiongenresales)+
  geom_col(aes(x = cum_NA_genre_sum,
             y = fct_reorder(Genre,cum_NA_genre_sum),
             fill = Genre))+
...
g2 <- ggplot(regiongenresales)+
  geom_col( aes(x = cum_EU_genre_sum,
             y = fct_reorder(Genre,cum_EU_genre_sum),
             fill = Genre,
             group = Genre))+
...
g3 <- ggplot(regiongenresales)+
  geom_col(aes(x = cum_JP_genre_sum,
             y = fct_reorder(Genre,cum_JP_genre_sum),
             fill = Genre,
             group = Genre))+
...
g4 <- ggplot(regiongenresales)+
  geom_col(aes(x = cum_other_genre_sum,
             y = fct_reorder(Genre,cum_other_genre_sum),
             fill = Genre,
             group = Genre))+
